...
class RestaurantController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    try {
      ...
      return redirect()->route('dashboard.restaurants.create')->withErrors(['fail' => '店舗の登録に失敗しました。']);
    }
  ...
  public function update(Request $request, Restaurant $restaurant)
  {
    ...
    try {
      ...
      return redirect()->route('dashboard.restaurants.edit', $restaurant)->withErrors(['fail' => '店舗の更新に失敗しました。']);
    }
